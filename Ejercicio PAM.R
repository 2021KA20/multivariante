...
### al agrupamiento, son dos clúster. Su valor de Silhouette es un poco
### más alto: 0.26, mientras que de 3 clúster es de 0.22 y de 4 clúster
### es de 0.23. Todavía hay datos mal clasificados, pero si se aumenta la cantidad
### de clúster, puede que se dé un mejor agrupamiento pero se corre el riesgo que
### el Average Silhouette sea mucho más bajo.
